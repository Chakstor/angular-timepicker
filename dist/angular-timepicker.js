...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return dnTimepickerPopup; });
var dnTimepickerPopup = (function () {
    function dnTimepickerPopup() {
        this.restrict = 'A';
        this.replace = true;
        this.transclude = false;
        this.template = "<ul class=\"dn-timepicker-popup dropdown-menu\" ng-style=\"{display: timepicker.isOpen && 'block' || 'none', top: position.top+'px', left: position.left+'px'}\"><li ng-repeat=\"time in timepicker.optionList()\" ng-class=\"{active: isActive($index) }\" ng-mouseenter=\"setActive($index)\"><a ng-click=\"select(time)\">{{time | date:timepicker.timeFormat}}</a></li></ul>";
    }
    dnTimepickerPopup.factory = function () {
        var directive = function () { return new dnTimepickerPopup(); };
        return directive;
    };
    dnTimepickerPopup.prototype.link = function (scope, element, attrs) {
        scope.timepicker.element = element;
        element.find('a').bind('click', function (event) {
            event.preventDefault();
        });
    };
    return dnTimepickerPopup;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__popup_directive__ = __webpack_require__(1);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return dnTimepickerDirective; });


var dnTimepickerDirective = (function () {
    function dnTimepickerDirective($compile, $parse, $position, $document, dateFilter, $dateParser, dnTimepickerHelpers, $log, $timeout) {
        ...
        this.dnTimepickerHelpers = dnTimepickerHelpers;
        this.$log = $log;
    ...
    dnTimepickerDirective.factory = function () {
        var directive = function ($compile, $parse, $position, $document, dateFilter, $dateParser, dnTimepickerHelpers, $log, $timeout) { return new dnTimepickerDirective($compile, $parse, $position, $document, dateFilter, $dateParser, dnTimepickerHelpers, $log, $timeout); };
        directive.$inject = ['$compile', '$parse', '$uibPosition', '$document', 'dateFilter', '$dateParser', 'dnTimepickerHelpers', '$log', '$timeout'];
        return directive;
    };
    dnTimepickerDirective.prototype.link = function (scope, element, attrs, ctrl) {
        ...
        function getUpdatedDate(date) {
            if (!current) {
                current = __WEBPACK_IMPORTED_MODULE_0_angular__["isDate"](scope.ngModel) ? scope.ngModel : new Date();
            }
        ...
        function setCurrentValue(value) {
            if (!__WEBPACK_IMPORTED_MODULE_0_angular__["isDate"](value)) {
        ...
        ctrl.$render = function () {
            element.val(__WEBPACK_IMPORTED_MODULE_0_angular__["isDate"](current) ? this.dateFilter(current, scope.timepicker.timeFormat) : ctrl.$viewValue ? ctrl.$viewValue : '');
        };
        // Parses manually entered time
        ctrl.$parsers.unshift(function (viewValue) {
            scope.viewValue = viewValue;
            var date = __WEBPACK_IMPORTED_MODULE_0_angular__["isDate"](viewValue) ? viewValue : this.$dateParser(viewValue, scope.timepicker.timeFormat);
            if (isNaN(date)) {
        ...
        scope.select = function (time) {
            if (!__WEBPACK_IMPORTED_MODULE_0_angular__["isDate"](time)) {
                return;
            }
        ...
        element.after(this.$compile(__WEBPACK_IMPORTED_MODULE_0_angular__["element"]('<div dn-timepicker-popup></div>'))(scope));
        // Set up the element
        element.bind('focus', function () {
            scope.openPopup();
        }).bind('blur', function () {
            if (scope.viewValue && !__WEBPACK_IMPORTED_MODULE_0_angular__["isDate"](this.$dateParser(scope.viewValue, scope.timepicker.timeFormat))) {
                if (isNaN(scope.viewValue)) {
                    scope.select(scope.timepicker.optionList()[0]);
                }
                else {
                    if (__WEBPACK_IMPORTED_MODULE_0_angular__["isDate"](scope.viewValue)) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_angular__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_angular___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_angular__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return dnTimepickerHelpers; });

var dnTimepickerHelpers = (function () {
    function dnTimepickerHelpers() {
        this.$get = function () { return ({
            ...
            buildOptionList: function (minTime, maxTime, step) {
                var result = [], i = __WEBPACK_IMPORTED_MODULE_0_angular__["copy"](minTime);
                while (i <= maxTime) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_angular__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_angular___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_angular__);
throw new Error("Cannot find module \"angular-dateParser\"");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angular_ui_bootstrap__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__popup_directive__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__directive__ = __webpack_require__(3);
...
__WEBPACK_IMPORTED_MODULE_0_angular__["module"]('dnTimepicker', ['ui.bootstrap.position', 'dateParser'])
    .factory('dnTimepickerHelpers', __WEBPACK_IMPORTED_MODULE_3__helpers__["a" /* dnTimepickerHelpers */])
    .directive('dnTimepickerPopup', __WEBPACK_IMPORTED_MODULE_4__popup_directive__["a" /* dnTimepickerPopup */].factory())
    .directive('dnTimepicker', __WEBPACK_IMPORTED_MODULE_5__directive__["a" /* dnTimepickerDirective */].factory());


/***/ })
/******/ ]);
//# sourceMappingURL=angular-timepicker.js.map